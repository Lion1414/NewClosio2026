...
const HeroDrainLines: React.FC = () => {
  return (
    ...
    >
      ...
      <path
        d="M -100 130 L 100 130 Q 170 130, 170 200 L 170 530 Q 170 600, 240 600 L 650 600"
        fill="none"
      ...
      <path
        d="M -100 10 L 400 10 Q 470 10, 470 80 L 470 530 Q 470 600, 540 600 L 650 600"
        fill="none"
        stroke="rgba(255, 255, 255, 0.15)"
        strokeWidth="32"
        strokeLinecap="round"
